...
public class AdminMemberInfoPaging {
	...
	//	pageCount == 10
	//	listCount == 10
	public AdminMemberInfoPaging(int totalCount) {
	...
	//	pageCount == 10
	//	listCount == 10
	public AdminMemberInfoPaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	//	pageCount == 10
	public AdminMemberInfoPaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public AdminMemberInfoPaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
