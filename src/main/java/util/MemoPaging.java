...
public class MemoPaging {
	...
	//	pageCount == 10
	//	listCount == 10
	public MemoPaging(int totalCount) {
	...
	//	pageCount == 10
	//	listCount == 10
	public MemoPaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	//	pageCount == 10
	public MemoPaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public MemoPaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
