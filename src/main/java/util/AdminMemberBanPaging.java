...
public class AdminMemberBanPaging {
	...
	//	pageCount == 10
	//	listCount == 10
	public AdminMemberBanPaging(int totalCount) {
	...
	//	pageCount == 10
	//	listCount == 10
	public AdminMemberBanPaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	//	pageCount == 10
	public AdminMemberBanPaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public AdminMemberBanPaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
