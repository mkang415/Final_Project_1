...
public class AdminReportPaging {
	...
	//	pageCount == 10
	//	listCount == 10
	public AdminReportPaging(int totalCount) {
	...
	//	pageCount == 10
	//	listCount == 10
	public AdminReportPaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	//	pageCount == 10
	public AdminReportPaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public AdminReportPaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
