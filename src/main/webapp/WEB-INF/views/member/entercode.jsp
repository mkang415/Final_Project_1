...
<form action="/member/entercode" method="post">

<div class="join_content">
	
	<div class="row_group">
		<h3 class="join_title">
		<label for="email">인증코드입력</label>
		</h3>
	<span class="intext"> <input type="text" id="code"
			name="code" class="inputtext" maxlength="100" /></span> 
	</div>
