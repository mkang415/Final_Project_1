...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
  	...
  	<c:if test="${ABP.curPage ne 1 }">
  		<li class="page-item"><a class="page-link" href="/admin/list?search=${ABP.search }"><span>처음</span></a></li>
  		<li class="page-item"><a class="page-link" href="/admin/list?curPage=${ABP.curPage-1 }&search=${ABP.search}"><span>&laquo;</span></a>
  	</c:if>
	...
	<c:forEach begin="${ABP.startPage }" end="${ABP.endPage }" var="i">
		...
		<c:if test="${ABP.curPage ne i}">
			<li class="page-item">
				<a class="page-link" href="/admin/list?curPage=${i }&search=${ABP.search}">${i }</a>
			</li>
		</c:if>
	</c:forEach>
    ...
    <c:if test="${ABP.curPage ne ABP.totalPage }">
    	<li class="page-item"><a class="page-link" href="/admin/list?curPage=${ABP.curPage+1 }&search=${ABP.search}"><span>&raquo;</span></a>
    </c:if>
  </ul>
</nav>
