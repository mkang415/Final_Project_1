...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
  	...
  	<c:if test="${AMBP.curPage ne 1 }">
  		<li class="page-item"><a class="page-link" href="/admin/banlist"><span>처음</span></a></li>
  		<li class="page-item"><a class="page-link" href="/admin/banlist?curPage=${AMBP.curPage-1 }"><span>&laquo;</span></a>
  	</c:if>
	...
	<c:forEach begin="${AMBP.startPage }" end="${AMBP.endPage }" var="i">
		...
		<c:if test="${AMBP.curPage ne i}">
			<li class="page-item">
				<a class="page-link" href="/admin/banlist?curPage=${i }">${i }</a>
			</li>
		</c:if>
	</c:forEach>
    ...
    <c:if test="${AMBP.curPage ne AMBP.totalPage }">
    	<li class="page-item"><a class="page-link" href="/admin/banlist?curPage=${AMBP.curPage+1 }"><span>&raquo;</span></a>
    </c:if>
  </ul>
</nav>
