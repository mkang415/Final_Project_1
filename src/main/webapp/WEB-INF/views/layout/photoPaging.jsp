...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
  	...
  	<c:if test="${photoPaging.curPage ne 1 }">
  		<li class="page-item"><a class="page-link" href="/board/photolist?search=${photoPaging.search}"><span>처음</span></a></li>
  		<li class="page-item"><a class="page-link" href="/board/photolist?curPage=${photoPaging.curPage-1 }&search=${photoPaging.search}"><span>&laquo;</span></a>
  	</c:if>
	...
	<c:forEach begin="${photoPaging.startPage }" end="${photoPaging.endPage }" var="i">
		...
		<c:if test="${photoPaging.curPage ne i}">
			<li class="page-item">
				<a class="page-link" href="/board/photolist?curPage=${i }&search=${photoPaging.search}">${i }</a>
			</li>
		</c:if>
	</c:forEach>
    ...
    <c:if test="${photoPaging.curPage ne photoPaging.totalPage }">
    	<li class="page-item"><a class="page-link" href="/board/photolist?curPage=${photoPaging.curPage+1 }&search=${photoPaging.search}"><span>&raquo;</span></a>
    </c:if>
  </ul>
</nav>
