...
<form id="writeSubmit" action="/diary/modify" method="post">
	<div id="write-field">
	...
	<input type="text" id="title" name="title" placeholder="Insert Title" value="${modifyDiary.title }"></input>
	<textarea id="summernote" name="content" placeholder="Content">${modifyDiary.content }</textarea>
